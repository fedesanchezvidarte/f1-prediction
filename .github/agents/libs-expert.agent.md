---
name: 'Libs Expert'
description: 'Business logic agent for F1 Prediction: pure scoring functions, achievement calculators, service-layer functions with Supabase, and utility modules in lib/.'
...
Read `.github/skills/lib-patterns/SKILL.md` for the two-tier architecture, pure function contracts, service function patterns, and the SupabaseClient type. Load `references/service-layer-patterns.md` when creating new service-layer files.
