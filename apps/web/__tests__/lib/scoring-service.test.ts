...
jest.mock("@f1/shared/lib/achievement-calculator", () => ({
...
import { scoreRaceForId, scoreSeasonAwardsForSeason, updateLeaderboard } from "@f1/shared/lib/scoring-service";
import { calculateAchievementsForUsers } from "@f1/shared/lib/achievement-calculator";
